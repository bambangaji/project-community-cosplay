                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                CustomWidget.customTextField(bgColor: Warna.grey),
                                Padding(
                                  padding: const EdgeInsets.only(
                                      bottom: 10.0, top: 10),
                                  child:
                                      CustomText().titleText("Select Character"),
                                ),
                                CustomWidget.customTextField(bgColor: Warna.grey),
                                Padding(
                                  padding: const EdgeInsets.only(
                              ...
                              Container(
                                ...
                                child: OutlinedButton(
                                  style: TextButton.styleFrom(backgroundColor: Warna.biruTua),
                                  onPressed: null, 
                                
                                child: CustomText().titleText("Submit",textColor: Warna.softWhite)),
                              )
                              ],
                            ),
                          ),
